<html>
  ...
  <body background-color="lightred">
		...
		<input type="password" id="password1.1" name="password1" placeholder="PASSWORD"><br>
		<input type="submit">
		<input type="reset">
		</form>
<script>
